...
L["rendFirstYellMsg"] = "酋長祝福的閃電，將在%s秒後施放。";
L["onyxiaFirstYellMsg"] = "奧妮克西婭的頭顱已插，閃電將在%s秒後施放。";
L["nefarianFirstYellMsg"] = "奈法利安的頭顱已插，閃電將在%s秒後施放。";
...
L["dayMedium"] = "天";
L["daysMedium"] = "天";
L["wintergraspTimer"] = "冬擁湖";
L["wintergraspWarning"] = "冬擁湖將在%s後開始";
L["Completed PvP dailies"] = "已完成PvP日常";
L["Hellfire Towers"] = "地獄火哨塔";
L["Terokkar Towers"] = "泰羅卡哨塔";
L["Nagrand Halaa"] = "納格蘭哈蘭";
L["wintergraspChat10Title"] = "冬擁湖 10分鐘";
L["wintergraspChat10Desc"] = "冬擁湖靈魂塔剩餘10分鐘時在聊天中輸出消息。";
L["wintergraspMiddle10Title"] = "冬擁湖 10分鐘";
L["wintergraspMiddle10Desc"] = "冬擁湖靈魂塔剩餘10分鐘時在螢幕中央顯示團隊警告樣式消息。";
...
L["ashenvaleWarning"] = "梣谷PvP活動即將開始 (聯盟 %s%%) (部落 %s%%).";
L["overlayShowBlackrockTitle"] = "顯示黑石活動計時器圖示";
L["overlayShowBlackrockDesc"] = "顯示黑石活動計時器圖示？";
L["Blackrock"] = "黑石大爆發";
L["blackrockEventRunning"] = "黑石大爆發進行中: %s";
L["blackrockEventStartsIn"] = "黑石大爆發將在%s後開始";
L["blackrockStartSoon"] = "黑石大爆發活動將在%s後開始";
L["Blackrock PvP Event"] = "黑石大爆發 PvP 活動";
L["Total honor this event"] = "本次活動總榮譽";
L["printStvCoinsTitle"] = "顯示荊棘谷硬幣數";
L["printStvCoinsDesc"] = "在活動期間將獲得的荊棘谷硬幣數量輸出到聊天。";
L["printBlackrockHonorTitle"] = "顯示黑石大爆發榮譽數";
L["printBlackrockHonorDesc"] = "在活動期間將黑石大爆發獲得的榮譽數量輸出到聊天。";
L["chatOnlyInCityTitle"] = "僅在城市中";
L["chatOnlyInCityDesc"] = "僅當您位於施放Buff的主要城市時，才輸出計時器和Buff掉落聊天消息（贊達拉Buff包含荊棘谷）。";
L["middleOnlyInCityTitle"] = "僅在城市中";
L["middleOnlyInCityDesc"] = "僅當您位於施放Buff的主要城市時，才在螢幕中央顯示計時器和Buff掉落消息（贊達拉Buff包含荊棘谷）。";
L["flashOnlyInCityTitle"] = "僅在城市中";
L["flashOnlyInCityDesc"] = "僅當您位於施放Buff的主要城市時，才在最小化時閃爍（贊達拉Buff包含荊棘谷）。";
L["blueShamansTitle"] = "藍色薩滿";
L["blueShamansDesc"] = "在經典版中是否將此插件中的薩滿顯示為藍色？";
L["dmfBuffDroppedNoCooldown"] = "已獲得暗月馬戲團增益 %s，此遊戲版本沒有冷卻時間。";
L["chronoboonReleasedNoCooldown"] = "您已使用時空寶珠釋放暗月馬戲團增益，此遊戲版本沒有冷卻時間。";
L["skipDmfCookieTitle"] = "跳過幸運餅乾";
L["skipDmfCookieDesc"] = "啟用此選項以在獲得DMF增益後跳過獲取幸運餅乾。";
L["No layers found yet."] = "尚未找到任何鏡像。";
L["Bi-Weekly raid reset"] = "雙週團隊副本重置";
L["Min Level"] = "最低等級";
L["Rend handed in by"] = "雷德首級交回：";
L["ago"] = "前";
L["Dropped"] = "已掉落";
L["Yes"] = "是";
L["No"] = "否";
L["Delete buff data?"] = "刪除增益數據？";
L["No characters with buffs found."] = "未找到擁有增益的角色。";
L["Unknown Layer"] = "未知鏡像";
L["Active"] = "啟用中";
L["noZonesMappedYet"] = "伺服器重啟後尚未映射任何區域。";
L["Rend log adjusted"] = "已按雷德日誌調整";
L["flashDisableRendTitle"] = "禁用雷德閃爍";
L["flashDisableRendDesc"] = "覆蓋設定以禁用所有與雷德相關的客戶端閃爍事件。";
L["flashDisableOnyTitle"] = "禁用奧妮克西婭閃爍";
L["flashDisableOnyDesc"] = "覆蓋設定以禁用所有與奧妮克西婭/奈法利安相關的客戶端閃爍事件。";
L["flashDisableZanTitle"] = "禁用贊達拉閃爍";
L["flashDisableZanDesc"] = "覆蓋設定以禁用所有與贊達拉相關的客戶端閃爍事件。";
L["soundsFirstYellRendTitle"] = "雷德增益即將到來";
L["soundsFirstYellRendDesc"] = "雷德首級交出後、增益即將落下的幾秒前播放的聲音（NPC首次吶喊）。";
L["soundsFirstYellOnyTitle"] = "奧妮克西婭/奈法利安增益即將到來";
L["soundsFirstYellOnyDesc"] = "奧妮克西婭/奈法利安首級交出後、增益即將落下的幾秒前播放的聲音（NPC首次吶喊）。";
L["resetFramesTitle"] = "重置視窗";
L["resetFramesDesc"] = "點擊此處將所有視窗位置重置到螢幕中央。";
L["buffHasNoCooldown"] = "此次掉落不會觸發冷卻";
L["noCooldown"] = "無冷卻";
L["showDisableLayerButtonsTitle"] = "顯示禁用鏡像按鈕";
L["showDisableLayerButtonsDesc"] = "在計時器/鏡像視窗中顯示禁用鏡像按鈕。";
L["Show Quest Handins Only"] = "僅顯示任務交回";
L["showQuestHandinsTooltip"] = "僅顯示雷德任務被交回的日誌條目。";
L["Molten Core"] = "熔火之心";
L["Onyxia's Lair"] = "奧妮克西婭的巢穴";
...
L["The Arcatraz"] = "禁魔監獄";
L["Black Morass"] = "黑暗沼澤";
L["Battle of Mount Hyjal"] = "海加爾山之戰";
L["Black Temple"] = "黑暗神殿";
...
L["layersHeaderDesc"] = "鏡像選項";
L["minimapLayerZoneIDTitle"] = "顯示小地圖ZoneID";
L["minimapLayerZoneIDDesc"] = "在您當前鏡像編號旁顯示當前區域的ZoneID。";
L["minimapLayerZoneIDTooltipTitle"] = "小地圖ZoneID提示";
L["minimapLayerZoneIDTooltipDesc"] = "這將使滑鼠懸停提示顯示您當前區域的所有鏡像ZoneID，方便您與另一陣營的角色或其他原因進行比較。";
L["Unknown"] = "未知";
...
L["Crossroads"] = "十字路口";
L["by"] = "作者";
L["For help or suggestions"] = "獲取幫助或建議";
L["rendLogQuestInfo"] = "雷德任務交回僅可在部落方顯示。";
L["recentlyKilledMsg"] = "收到新的最近被擊殺的%s NPC計時器，死於%s前";
L["Shattrath City"] = "撒塔斯城";
L["rendOrgRelayMsg"] = "已根據奧格瑪消息啟動雷德十字路口計時條。";
L["Guild versions seen since logon"] = "登入後所見到的公會版本";
