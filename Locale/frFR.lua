...
L["rendFirstYellMsg"] = "Rend va être posé dans %s secondes.";
L["onyxiaFirstYellMsg"] = "Onyxia va être posé dans %s secondes.";
L["nefarianFirstYellMsg"] = "Nefarian va être posé dans %s secondes.";
